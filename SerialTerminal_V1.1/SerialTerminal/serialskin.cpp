...
void SerialSkin::on_pushButton_TextColor_clicked()
{
    ...
    ui->textEdit->setStyleSheet("color:"+TextColor.name()+";"+"background-color:"+TextColorInSetting.name()+";");
}
...
void SerialSkin::on_pushButton_BackGroundColor_clicked()
{
    ...
    ui->textEdit->setStyleSheet("color:"+TextColor.name()+";"+"background-color:"+BackGroundColorInSetting.name()+";");
}
